...
namespace product.Messaging.Publishers
{
    public class MessagePublisher : IMessagePublisher, IDisposable
    {
        ...
        private const string AddProductEventsExchange = "add_product_events_exchange";
        ...
        public async Task AddProductSucceededEventAsync(AddProductSucceededEvent eventData)
        {
            await PublishAsync(eventData, AddProductEventsExchange, "add_product.succeeded", nameof(AddProductSucceededEvent));
        }

        public async Task AddProductFailedEventAsync(AddProductFailedEvent eventData)
        {
            await PublishAsync(eventData, AddProductEventsExchange, "add_product.failed", nameof(AddProductFailedEvent));
        }
